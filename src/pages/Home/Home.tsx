      ...
      <main className={styles.home}>
        <section className={styles.home__serviceSection}>
          ...
          <div className={styles.home__serviceSection__contentBox}>
            <h2 className={styles.home__serviceSection__contentBox__title}>
              TV Shows
            </h2>
            ...
            <button className={styles.home__serviceSection__contentBox__btn}>
              See More
            </button>
          </div>
        </section>
        ...
        <section
          className={`${styles.home__serviceSection} ${styles["home__serviceSection--reversed"]}`}
        >
          <div className={styles.home__serviceSection__imgBox}>
            <picture>
        ...
        <section className={styles.home__serviceSection}>
          ...
          <div className={styles.home__serviceSection__contentBox}>
            ...
            <p className={styles.home__serviceSection__contentBox__description}>
              Join live broadcasts, gaming streams, and community events right
              in your browser.
            </p>
            <button className={styles.home__serviceSection__contentBox__btn}>
              See More
        ...
        >
          ...
          <div className={styles.home__serviceSection__contentBox}>
            ...
            <p className={styles.home__serviceSection__contentBox__description}>
              Play exciting titles instantly without downloads — just click and
              play online.
            </p>
            <button className={styles.home__serviceSection__contentBox__btn}>
              See More
          ...
          <div className={styles.home__benefitsList}>
            <div className={styles.home__benefit}>
              ...
              <div className={styles.home__benefit__textBox}>
                <h3 className={styles.home__benefit__textBox__title}>
                  Enjoy and Save
                </h3>
