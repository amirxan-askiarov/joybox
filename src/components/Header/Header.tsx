...
const Header: React.FC = () => {
  ...
  const mobileMenuOpen = isDesktop ? false : isMenuOpen;
    ...
    >
      <header className={styles.header}>
        <nav className={styles.header__nav} aria-label="Main navigation">
          ...
          <ul
            className={`${styles.header__categories} ${
              !isDesktop &&
              (isMenuOpen ? styles["header__categories--open"] : "")
            }`}
            id="mobile-menu-list"
            aria-hidden={!isDesktop && !isMenuOpen}
          >
            <li>
              <a id="movies" href="/movies" className={styles.header__link}>
                Movies
              </a>
            </li>
            <li>
              <a id="tv-shows" href="/tv-shows" className={styles.header__link}>
                TV Shows
              </a>
            </li>
            <li>
              <a id="streams" href="/streams" className={styles.header__link}>
                Streams
              </a>
            </li>
            <li>
              <a id="games" href="/games" className={styles.header__link}>
                Online Games
              </a>
            </li>
            ...
            {!isDesktop && (
              <li>
                <a
                  href="/registration"
                  className={`${styles.header__joinBtn} ${styles["header__joinBtn--mobile"]}`}
                >
                  Start JoyBox
                </a>
              </li>
